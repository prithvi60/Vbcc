...
const Newsletter = () => {
  return (
    <section className="px-6 md:px-10 xl:px-16 2xl:px-20 py-16 xl:py-12 2xl:py-16 text-white">
      <div className="py-10 px-5 md:p-10 2xl:p-12 bg-primary space-y-10 2xl:space-y-12 rounded-lg md:rounded-none">
        ...
        <form
          ...
          acceptCharset="UTF-8"
        >
          <div className="flex flex-wrap sm:flex-nowrap items-center max-w-[320px] md:w-[375px] rounded-full border py-2 px-3 border-secondary focus:border-secondary mx-auto mb-4 sm:mb-0 bg-secondary">
            <input
              required
              name="Email"
              type="email"
              placeholder="Your Email"
              className="bg-secondary placeholder:text-zinc-500 !border-none !outline-none placeholder:font-Nunito w-[175px] md:w-[198px] text-primary text-base md:text-lg"
            />
            {/* px-4 py-2 */}
            <button
              type="submit"
              className={`hidden sm:block rounded-full px-4 py-3 group bg-primary hover:bg-info text-center text-base duration-700 delay-75 font-urbanist capitalize w-full`}
            >
