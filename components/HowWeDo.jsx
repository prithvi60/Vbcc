...
const HowWeDo = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center w-full h-full gap-16 px-6 py-8 overflow-hidden text-white lg:flex-row font-Montserrat md:py-12 md:px-8 xl:px-14 bg-primary">
      ...
      <div className="flex h-[380px] md:h-[520px] w-full max-w-5xl shadow overflow-hidden">
        {items.map((item) => {
          return (
            <Panel
              key={item.id}
    ...
    <>
      ...
      >
        <Link
          ...
          href={"/contact"}
          className={`leading-7 tracking-wider rotate-180 block px-2 py-2 md:py-6  group bg-white shadow-2xl shadow-black bg-opacity-20 transition-colors duration-400 ease-out hover:bg-primary text-center text-base font-urbanist capitalize w-max absolute top-8 right-5 md:bottom-5 md:left-3 z-10`}
        >
          <h3
