            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="space-y-6 text-warning">
                ...
                <p className="text-sm md:text-base font-urbanist md:w-[78%] lg:w-full text-justify tracking-normal leading-snug">
                  ...
                  <br />
                  <br />
                  We take pride in utilizing top-grade raw materials to
                  manufacture our range of cutting-edge instruments. Our
                  extensive product line-up includes a,
                  <span className="font-semibold capitalize">
                    Thermal Conductivity Apparatus, Microwave Furnaces up to
                    2000°C, Gas Sensor, Modulus of Rupture (MOR) Apparatus, Cold
                    Crushing Strength (CCS) Apparatus, Presses up to 500 TON,
                    Furnaces up to 2500°C, Chemical Vapour Deposition (CVD)
                    Instrument, Tubular, Vacuum, Box, Industrial Furnaces up to
                    2500°C, Biomass Pyrolysis, and Dilatometer in{" "}
                    <span>{place}</span>
                  </span>
                  .
                  <br />
                  ...
                  , VBCC has established a strong presence in the market.
                  Renowned companies trust us for a diverse range of laboratory
                  instruments and furnaces. Whether you require precise
                  ...
                  assure your prompt delivery of the right product to your
                  facility. Choose VBCC for cutting-edge technology,
