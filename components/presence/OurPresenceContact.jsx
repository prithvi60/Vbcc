...
export const OurPresenceContact = ({ title, mobTitle, para }) => {
  ...
  return (
    <section className="py-16 px-5 md:py-[60px] md:px-10 xl:px-20 ">
      <div className="bg-transparent p-10 space-y-10">
        <h3 className="hidden md:block text-[40px] text-warning text-center font-Lora">
          {title}
        </h3>
        <h3 className="block md:hidden text-3xl text-warning text-center font-Lora">
          {mobTitle}
        </h3>
        <p className="text-base md:text-2xl text-warning md:mx-auto font-urbanist w-full md:w-11/12 text-center tracking-tight md:tracking-wide leading-snug opacity-80">
          {para}
        </p>
        <span className="flex flex-col-reverse md:flex-row justify-center items-center gap-3 md:gap-6">
          ...
          <div className="block space-y-2 relative">
            ...
            {Copied && (
              <div className="absolute -bottom-7 left-0 text-warning text-base text-center w-max">
          ...
          <Btn2
            ...
            HtextColor={"text-white"}
            bColor={"border-warning group-hover:border-white"}
            title={"Contact Us"}
            href={"/contact"}
            background={"transparent"}
          />
