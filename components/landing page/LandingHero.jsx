                    ...
                    <div className="flex flex-col items-center w-full h-full gap-5 md:flex-row md:gap-0">
                        <div className="w-full md:w-4/5">
                            <div className="w-full space-y-4 md:w-1/2 xl:w-4/5">
                                ...
                                <h2 className="text-[32px] font-bold tracking-wider md:text-[48px] xl:text-[64px] leading-tight">
                        ...
                        <div className="relative w-full md:w-1/2 xl:w-2/5">
                            <div className="relative w-full h-56 xl:h-72">
                                <Image alt="image" fill src={"/hero-1.png"} className="z-20 object-contain object-center" />
                            </div>
                            <h4 className="font-semibold text-center text-[18px] md:text-[26px] xl:text-[32px] leading-7 tracking-wider">Zirconia Sintering Furnance</h4>
                            <div className="absolute top-3 z-10 left-11 md:left-6 xl:left-10 flex justify-between items-center rounded-full bg-gradient-to-b from-[#13294F56] to-[#6B778C56] bg-opacity-80 size-40 md:size-52 xl:size-64"></div>
                        </div>
                    </div>
                </div>
            </div>
