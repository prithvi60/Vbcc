...
import { Link as ScrollEl } from "react-scroll";
...
import { ResponsiveSVG } from "/svg_components/Svg";
    ...
    <section className="relative w-full h-full text-white mb-7">
      <div className="relative w-full h-full overflow-hidden rounded-2xl">
        ...
        <div className="absolute z-20 w-[80%] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 font-Montserrat ">
          <div className="absolute -left-10 hidden w-full md:block -top-20 pointer-events-none">
            <ResponsiveSVG />
          </div>
          <div className="absolute left-0 block w-full h-auto md:hidden -top-4 pointer-events-none">
            <ResponsiveSVG />
          </div>
                ...
                <div className="w-full space-y-2 md:space-y-4 md:w-4/5 xl:w-4/5">
                  ...
                  >
                    <button
                      ...
                      className={` font-semibold w-fit transition-all shadow-[3px_3px_0px_white] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] px-6 py-2 flex items-center text-sm md:text-base gap-3 capitalize bg-info text-white !rounded-full z-1000`}
                    >
                      <h4>Products</h4>
                      <span>
            ...
            <div className="relative w-full md:w-1/2 xl:w-2/5">
              <div className="relative w-48 h-48 mx-auto md:w-56 md:h-56 xl:h-72 xl:w-72 group ">
                <Image
                  ...
                  fill
                  src={"/hero-1.png"}
                  className="z-20 object-contain object-center  transition-all duration-500 ease-linear transform hover:scale-125"
                />
                <div className="absolute top-2 md:top-4   group-hover:bg-gradient-to-b group-hover:from-info group-hover:to-info transition-colors duration-400 ease-in-out z-10 left-1 flex justify-between items-center rounded-full bg-gradient-to-b from-[#13294F56] to-[#6B778C56] bg-opacity-80 size-44 md:size-52 xl:size-64"></div>
              </div>
