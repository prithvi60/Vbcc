          ...
          <div className="flex flex-col items-center w-full h-full gap-10 md:flex-row">
            ...
            <div className="relative w-full md:w-1/2 xl:w-2/5">
              <div className="relative w-48 h-48 mx-auto md:w-56 md:h-56 xl:h-72 xl:w-72 group">
                ...
                />
                <div className="absolute top-2 md:top-4 group-hover:bg-info transition-colors duration-400 ease-in-out z-10 left-1 flex justify-between items-center rounded-full bg-gradient-to-b from-[#13294F56] to-[#6B778C56]  size-44 md:size-52 xl:size-64"></div>
              </div>
