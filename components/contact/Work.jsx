...
export const Work = () => {
  return (
    <section className="px-5 md:px-10 py-[60px] lg:px-[60px] text-warning space-y-7 md:space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0 md:gap-x-8 text-warning">
            ...
            <div className="block space-y-7 md:space-y-10">
                ...
                <div className="space-y-3 md:space-y-5">
                    ...
                    <p className="font-Lora text-xl md:text-2xl tracking-normal w-full lg:w-11/12">2207, 3rd Link Street, Nehru Nagar Industrial Estate, Kottivakkam, Chennai-600 041.</p>
                </div>
                <div className="space-y-3 md:space-y-5">
