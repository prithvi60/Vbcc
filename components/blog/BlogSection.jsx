...
export const BlogSection = () => {
  return (
    <section className="px-5 py-10 md:px-10 md:py-[60px] lg:p-[60px] font-urbanist bg-secondary">
        ...
        classNames={{
          tabList:
            "gap-4 w-full relative rounded-none p-0 h-auto flex-wrap pb-5",
      ...
      >
        {allBlogContent.map((item)=>(
          ...
          >
            <BlogCards item={item} blogContents={item.blogContents} MainBlog={item.MainBlog}/>
          </Tab>
            ))}
      </Tabs>
    </section>
