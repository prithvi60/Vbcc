    ...
    <section className="px-5 py-10 md:py-[60px] md:px-[60px] bg-primary" id="visitation">
      ...
      <div className="w-full md:w-1/2 xl:w-[35%] md:space-y-8">
        ...
        <div className="block space-y-10 md:space-y-24 h-full w-full">
            ...
            <div className="p-4 rounded-full cursor-pointer border border-white active:border-white" onClick={handlePrev}>
            <GoArrowLeft className="h-5 w-5 text-white active:text-white"/>
            </div>
            <div className="p-4 rounded-full cursor-pointer border border-white active:border-white" onClick={handleNext}>
            <GoArrowRight className="h-5 w-5 text-white active:text-white"/>
            </div>
            </div>
            </div>
        </div>
