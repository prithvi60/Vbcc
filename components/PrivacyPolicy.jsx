  ...
  return (
    <section className="mt-20 space-y-3 padding text-primary font-Montserrat md:mt-28 xl:mt-32 md:space-y-4">
      ...
      <div className="space-y-4">
        <h4 className="block text-[20px] md:text-[28px] font-bold tracking-wider w-full">
        ...
        <div className="space-y-3">
          ...
          <h4 className="block text-[20px] md:text-[28px] font-bold tracking-wider w-full">
            <div className="space-y-3">
              ...
              <p className="text-base font-normal tracking-normal lg:text-lg">
                ...
                "Our" in this Agreement) refers to VBCC High Temperature
                Instruments Pvt Ltd, 207, 3rd Link Rd, Nehru Nagar, Perungudi,
                ...
                <br />
                Country refers to: Tamil Nadu, India Device means any device
      ...
      <div className="space-y-3">
        ...
        <p className="space-y-2 text-base font-normal lg:text-lg">
          The company allows You to create an account and log in to use the
          service through the following Third-party Social Media Services:
        </p>
        <ul className="space-y-2 text-base font-normal list-disc lg:text-lg">
          <li>Google</li>
          <li>Facebook</li>
          <li>Instagram</li>
          <li>Twitter</li>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-base font-normal lg:text-lg">
              <li>By email: info@vbccinstruments.com</li>
              <li>
                By visiting this page on our website:
                https://vbccinstruments.com/
              </li>
              <li>By phone number: 73388 94199</li>
            </ul>
          </div>
        </div>
      </div>
