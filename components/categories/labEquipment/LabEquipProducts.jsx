...
const LabEquipProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"https://cdn.shopifyapp.shop/vbcc/Products/Lab_Equipments/Spin%20Basic/Isometric.png"}
                heroBg={"https://cdn.shopifyapp.shop/vbcc/homepage/Lab%20Equipment%20Category%20Image.jpg"}
                title={"Lab Equipment"}
                desc1={
