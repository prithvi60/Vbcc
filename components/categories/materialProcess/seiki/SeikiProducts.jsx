...
const SeikiProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/seiki/Vacuum%20Hot%20Press/isometric.png"}
                heroBg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/Seikei.jpg"}
                title={"Presses"}
                desc1={
