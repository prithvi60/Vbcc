...
const SeikiProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/seiki/Vacuum%20Hot%20Press/isometric.png"}
                heroBg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/Seikei.jpg"}
                title={"Presses"}
                desc1={
