...
const MaterialProcessingEquipment = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/funsai/planetary%20ball%20mill%20(monomill)/isomteric-left.png"}
                heroBg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/MPR%20Bg%20Image_jpg.png"}
