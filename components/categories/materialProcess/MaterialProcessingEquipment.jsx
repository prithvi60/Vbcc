...
const MaterialProcessingEquipment = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"https://cdn.webibee.com/vbcc/Products/MPE/funsai/planetary%20ball%20mill%20(monomill)/isomteric-left.png"}
                heroBg={"https://cdn.webibee.com/vbcc/Products/MPE/MPR%20Bg%20Image_jpg.png"}
