...
const FunsaiProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/funsai/multideck%20two%20tier%20(polyuruthene)/isometric-left.png"}
                heroBg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/Funsai_jpg.png"}
                title={"Ball Mills"}
                desc1={
