...
const OshidashiProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/oshidashi/automatic%20extruder/isometric.png"}
                heroBg={"http://cdn.shopifyapp.shop/vbcc/Products/MPE/Oshidashi.jpg"}
                title={"Extruders"}
                desc1={
