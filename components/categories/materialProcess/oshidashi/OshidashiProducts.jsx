...
const OshidashiProducts = () => {
    return (
        <>
            <CategoryHero
                categoryImg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/oshidashi/automatic%20extruder/isometric.png"}
                heroBg={"https://cdn.shopifyapp.shop/vbcc/Products/MPE/Oshidashi.jpg"}
                title={"Extruders"}
                desc1={
