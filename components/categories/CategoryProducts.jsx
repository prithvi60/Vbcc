                ...
                {data.map((list, idx) => (
                    ...
                    >
                        <div className="relative mx-auto transition-all duration-500 ease-linear transform w-36 h-36 group-hover:scale-150 xl:w-72 xl:h-44">
                            ...
                            />
                            <div className="absolute top-0 -z-10 left-12 flex justify-between items-center rounded-full bg-gradient-to-b from-[#13294F56] to-[#6B778C56] bg-opacity-80 size-32 xl:size-48 transition-all duration-500 ease-linear group-hover:scale-[0.70] group-hover:bg-gradient-to-b group-hover:from-info group-hover:to-info"></div>
                        </div>
