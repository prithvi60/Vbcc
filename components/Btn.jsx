...
export const Btn = ({Hbgcolor,textColor,HtextColor,title,href,bColor}) => {
  return (
    <Link href={href} className={`block rounded-full px-4 py-3 border ${bColor} bg-transparent hover:${Hbgcolor} group text-center text-base duration-700 delay-75 font-urbanist capitalize h-auto w-max`}>
...
export const Btn2 = ({Hbgcolor,textColor,HtextColor,title,href,bColor,background}) => {
  return (
    <Link href={href} className={`block rounded-full px-6 py-5 border ${bColor} bg-transparent hover:${Hbgcolor} group/btn2 text-center text-base duration-700 delay-75 font-urbanist capitalize w-max ${background}`}>
      <div className={`h-6 w-full overflow-hidden`}>
