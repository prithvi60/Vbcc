        ...
        <div className="text-center md:text-left group w-full z-10 border border-white relative group">
          <div className="relative h-[220px] md:h-[240px] w-full">
            <Image
              ...
              blurDataURL={
                "https://ik.imagekit.io/webibee/VBCC/hero-bg.png?tr=bl-50"
              }
            />
          </div>
        ...
        <div className="text-center md:text-left group w-full z-10 border border-white relative group">
          <div className="relative h-[220px] md:h-[240px] w-full ">
            <Image
              ...
              className="absolute object-cover object-center brightness-50 hidden group-hover:block"
              blurDataURL={
                "https://ik.imagekit.io/webibee/VBCC/hero-bg-2.png?tr=bl-50"
              }
            />
          </div>
          <div className="py-8 px-5 md:py-6 md:px-10 absolute top-0 left-0 h-[220px] md:h-[240px] w-full bg-secondary z-10 group-hover:bg-transparent group-hover:transition-all group-hover:duration-[2500]
        ...
        <div className="text-center md:text-left group w-full z-10 border border-white relative md:col-span-2 xl:col-auto group">
          <div className="relative h-[220px] md:h-[240px] w-full ">
            <Image
              ...
              className="absolute object-cover object-center brightness-50 hidden group-hover:block"
              blurDataURL={
                "https://ik.imagekit.io/webibee/VBCC/hero-bg-3.png?tr=bl-50"
              }
            />
          </div>
          <div className="py-8 px-5 md:py-6 md:px-10 absolute top-0 left-0 h-[220px] md:h-[240px] w-full bg-secondary z-10 group-hover:bg-transparent group-hover:transition-all group-hover:duration-[2500]
