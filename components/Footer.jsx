...
const Footer = () => {
  return (
    <footer className="flex flex-col md:grid md:grid-cols-2 xl:grid-cols-3 font-urbanist">
      ...
      <div className="flex flex-col justify-start gap-16 md:justify-between items-start font-urbanist bg-primary py-10 px-5 md:py-16 md:px-10 xl:p-16 h-full md:h-[388px] border-r-1 border-b-1 border-[#2D4152] col-span-2 xl:col-auto text-sm">
      ...
      <div className=" p-5 md:px-16 md:py-5 text-zinc-500 border-b-1 border-[#2D4152] bg-primary col-span-3 tracking-tight font-semibold font-urbanist leading-snug">
      ...
      <div className="text-sm p-5 md:px-16 md:py-5 text-zinc-500 border-b-1 border-[#2D4152] bg-primary col-span-3 font-urbanist">
