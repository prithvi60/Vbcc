  ...
  return (
    <footer className="flex flex-col md:grid md:grid-cols-2 xl:grid-cols-3 font-urbanist">
      ...
      <div className="text-sm p-5 md:px-16 md:py-5 text-secondary border-y-1 border-[#2D4152] bg-primary col-span-3 font-urbanist">
        <div className="flex flex-col md:flex-row justify-center gap-2.5 md:justify-between items-center">
          <p>©VBCC HTI. All Rights Reserved.</p>
          <p>Made & Maintained By <Link href={"https://webibee.com/"} target="_blank" className="underline hover:animate-pulse decoration-white">Webibee</Link></p>
